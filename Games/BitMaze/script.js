...
class Rect extends Point {
  ...
  collides(r) {
    return r.contains(this.left, this.top) || r.contains(this.right, this.top) || r.contains(this.left, this.bottom) || r.contains(this.right, this.bottom);
  }
}
const State = {
  TITLE: 0,
...
_defineProperty(Item, "WIDTH", 20);
_defineProperty(Item, "HEIGHT", 20);
_defineProperty(Item, "LARGE", "large");
_defineProperty(Item, "SMALL", "small");
_defineProperty(Item, "POWERBALL", "powerball");
_defineProperty(Item, "TYPES", ["large", "small", "powerball"]);
...
_defineProperty(Particle, "WIDTH", 4);
_defineProperty(Particle, "HEIGHT", 4);
...
_defineProperty(Brick, "WIDTH", 50);
_defineProperty(Brick, "HEIGHT", 20);
...
_defineProperty(Ball, "WIDTH", 10);
_defineProperty(Ball, "HEIGHT", 10);
_defineProperty(Ball, "DEFAULT_VEL_X", 0);
_defineProperty(Ball, "DEFAULT_VEL_Y", 5);
...
_defineProperty(Pad, "WIDTH", 100);
_defineProperty(Pad, "WIDTH_L", 200);
_defineProperty(Pad, "WIDTH_S", 50);
_defineProperty(Pad, "HEIGHT", 10);
_defineProperty(Pad, "DEFAULT_POS_Y", 0.9);
let lifes = 3,
  state = State.TITLE,
  countdown = 3,
  startCountdown = null,
...
function renderGameOver(now) {
  renderBouncingText(now, "GAME OVER");
}
function renderWon(now) {
  renderBouncingText(now, "YOU WON!");
}
