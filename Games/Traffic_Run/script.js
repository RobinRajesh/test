var Game = (function () {
  ...
  function renderHomeScreen (viewport) {
      ...
      viewport.fillText('This is a small Retro game where you need to shoot zombies', bounds.x + 82, bounds.y + 132);
      viewport.fillText('and kill them!', bounds.x + 82, bounds.y + 148);
