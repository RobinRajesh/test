...
const STATE_TITLE = 0,
   ...
   */
  POST_FX = false,
  // this enables or disables the post fx rendering, if the game is running slow set this to false
  GLOW_FX = true,
  // this enables or disables the glow effect, if the game is running slow set this to false
  PARTICLES_FX = true,
  // this enables or disables the particles effect, if the game is running slow set this to false
  BACKGROUND = true,
  // this enables or disables the background, if the game is running slow set this to false
  GLOW = GLOW_FX ? 64 : 0,
  PROJECT_D = 4,
  PROJECT_X = 2,
  PROJECT_Y = 1,
