...
class playGame extends Phaser.Scene{
  ...
  preload(){
  		var progressBox = this.add.rectangle(gameOptions.width/2,10, 55, 8, 0x222222);
  		var progressBar = this.add.rectangle(gameOptions.width/2,10, 55, 8, 0xffffff);
	    
	    this.load.on('progress', function (value) {
	      	console.log(value);
	      	progressBar.width = 55 * value;
	    });

	    this.load.on('complete', function () {
	        progressBar.destroy();
	        progressBox.destroy();
					document.getElementById("preloadImage").remove();
	    });

		this.load.image("background", "https://retif-yayin.github.io/Race00/assets/sprites/bg.png");
		this.load.image("enemy", "https://retif-yayin.github.io/Race00/assets/sprites/car-enemy.png");
		this.load.image("enemy2", "https://retif-yayin.github.io/Race00/assets/sprites/car-enemy2.png");
		this.load.image("player", "https://retif-yayin.github.io/Race00/assets/sprites/car-player.png");
		this.load.image("fuel", "https://retif-yayin.github.io/Race00/assets/sprites/fuel.png");
		this.load.image("road", "https://retif-yayin.github.io/Race00/assets/sprites/road.png");
		this.load.image("tree", "https://retif-yayin.github.io/Race00/assets/sprites/tree.png");
		this.load.image("panel", "https://retif-yayin.github.io/Race00/assets/sprites/ui.png");

		this.load.image("font", "https://retif-yayin.github.io/Race00/assets/sprites/ui-font.png");

		this.load.audio("music", "https://retif-yayin.github.io/Race00/assets/sounds/leap.WAV");
		this.load.audio("carstart", "https://retif-yayin.github.io/Race00/assets/sounds/carstart.wav");
		this.load.audio("fuel", "https://retif-yayin.github.io/Race00/assets/sounds/fuel.wav");
		this.load.audio("fuelend", "https://retif-yayin.github.io/Race00/assets/sounds/fuelend.wav");
		this.load.audio("end", "https://retif-yayin.github.io/Race00/assets/sounds/end.wav");
	}
